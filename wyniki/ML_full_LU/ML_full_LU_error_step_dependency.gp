#   KOMENDA wywołania: 
#   gnuplot "ML_full_LU_error_step_dependency.gp"
...
set title "ML full LU: Zaleznosc log_{10}(error_{max}) od log_{10}(h)"
...
plot "ML_full_LU_results_error_step.csv" using 1:2 with linespoints lw 2 pt 7 title "Doswiadczalny rzad dokladnosci"

# Dopasowanie prostej: funkcja liniowa f(x)=A*x+B
f(x) = A*x + B
fit f(x) "ML_full_LU_results_error_step.csv" using 1:2 via A, B
