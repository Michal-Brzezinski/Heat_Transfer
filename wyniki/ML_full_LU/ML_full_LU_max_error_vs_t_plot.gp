#   Wywołanie: 
#   gnuplot "ML_full_LU_max_error_vs_t_plot.gp"
...
set title "ML-full LU: Zaleznosc error_{max} od t"
...
plot "ML_full_LU_maxerror_vs_time.csv" using 1:2 with linespoints lw 2 pt 7 title "Doswiadczalny rzad dokladnosci"
