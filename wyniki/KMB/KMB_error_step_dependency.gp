#   KOMENDA wywołania: 
#   gnuplot "wykresy/KMB_error_vs_h/error_step_dependency.gp"
...
set title "KMB: Zaleznosc log_{10}(error_{max}) od log_{10}(h)"
...
plot "KMBresults_error_step.csv" using 1:2 with linespoints lw 2 pt 7 title "Doswiadczalny rzad dokladnosci"

# Dopasowanie prostej: funkcja liniowa f(x)=A*x+B
f(x) = A*x + B
fit f(x) "KMBresults_error_step.csv" using 1:2 via A, B
