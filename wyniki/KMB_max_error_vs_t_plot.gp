#   Wywołanie: 
#   gnuplot "KMB_max_error_vs_t_plot.gp"
...
set title "Zależność error_{max} od t"
...
plot "KMB_maxerror_vs_time.csv" using 1:2 with linespoints lw 2 pt 7 title "Dośw. rząd dokładności"
