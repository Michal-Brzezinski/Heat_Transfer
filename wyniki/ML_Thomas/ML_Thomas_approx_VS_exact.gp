#   Wywołanie: 
#   gnuplot "ML_Thomas_approx_VS_exact.gp"
...
plot "ML_Thomas_results39038iter.csv" using 1:2 with points pointtype 7 linecolor rgb "red" title "U_{KMB}", \
     "ML_Thomas_results39038iter.csv" using 1:3 with lines linewidth 2 linecolor rgb "blue" title "U_{exact}"
